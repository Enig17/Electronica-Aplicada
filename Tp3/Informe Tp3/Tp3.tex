...
\section*{Acceso al informe digital}
\addcontentsline{toc}{section}{Acceso al informe digital}

\begin{center}
	
	El informe completo se encuentra disponible en el repositorio de GitHub.\\[0.5cm]
	
	\qrcode[height=4cm]{https://github.com/Enig17/Electronica-Aplicada/blob/f6c650413b75fdd316e87fe200fa76ec4ed0b9c6/Tp3/Informe\%20Tp3/Tp3.pdf}
	
	\vspace{0.4cm}
	
	\textbf{Escanear el código QR para acceder al informe.}
