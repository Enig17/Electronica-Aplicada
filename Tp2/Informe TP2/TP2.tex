...
\begin{document}
	...
	\begin{align}
		V_{\text{vacío}} &= 36,33~\text{V},
		\\
		V_{\text{carga}} &= 24,15~\text{V},
		\\
    ...
    El ripple medido a la entrada del regulador fue:
	...
	térmicas seguras.
    La temperatura máxima de operación segura recomendada para la juntura del LM317 es de $125~^\circ\text{C}$. Por lo que en este caso es necesario el uso de un disipador para que el dispositivo funcione correctamente. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{FRin.png}
    \caption{Ripple de entrada al regulador}
...
\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{medicion ripple de salida de regulador.}
		\label{fig:ripplesalida}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{medicion con reostato.}
		\label{fig:mediciones1}
	\end{figure}
...
\section{Acceso digital al informe}

\begin{center}
	\qrcode[height=4cm]{https://github.com/Enig17/Electronica-Aplicada/blob/87ee7fb1f7b14059d3edf0ff2540d80d64404c7f/Tp2/Informe\%20TP2/TP2.pdf}
	
	\vspace{0.3cm}
	
	\textit{Escanear el código QR para acceder a la versión digital del informe.}
\end{center}
	% ============================================================
	% FIN DEL DOCUMENTO
	% ============================================================
